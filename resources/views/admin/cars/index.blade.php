                                                            ...
                                                            <div class="rent-box rent-car" id="booking-sidebar">
                                                                ...
                                                                <div class="line-form local"><label>Địa điểm giao nhận
                                                                    ...
                                                                    <div class="note">
                                                                        ...
                                                                        <p class="subnote"><span> Không hỗ trợ giao nhận xe tận nơi. </span>
                                                                            Địa chỉ cụ thể
            ...
            $.ajax({
                ...
                success: function (response) {
                    response.data.data.forEach(function (each) {
                        ...
                        let status_ready = "<button type='button' id='btn-modal-form-create-bill-" + each.id + "' data-toggle='modal' data-target='#modal-form-create-bill' class='btn btn-outline-info'><i class='uil-money-bill'></i></button>";
                        ...
                        {{--let route_car_edit = "{{route("admin.cars.edit", '')}}"+"/"+each;--}}
                        {{--let route_car_destroy = '{{route("admin.cars.destroy")}}/'+each.id;--}}
                        ...
                        let action = "<a href='" + route_car_edit + "' class='action-icon'><i class='mdi mdi-wrench'></i></a>";
                        {{--+ "<form action='" + route_car_destroy + "' method='post' class='action-icon'>"+--}}
                        {{--@csrf @method('DELETE') +--}}
